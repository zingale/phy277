...
Our project is now found at: :samp:`https://github.com/<username>/<reponame>`,
...
Carpentry `Create an SSH key pair <https://swcarpentry.github.io/git-novice/07-github.html#ssh-background-and-setup>`_ section.
...
1. A the bash prompt generate a new key pair:
   ...
   It will ask you for a passpharse---just hit :kbd:`Enter` to keep it
...
format <https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax>`_

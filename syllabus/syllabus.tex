...
\begin{center}
{\large \sffamily \bfseries PHY 277: Computation for Physics and Astronomy / Spring 2026} {\footnotesize (rev.\ 1.03; 2026-01-27)}\\[1.5mm]
{\em Instructor:} Prof.\ Michael Zingale, ESS 452, \href{mailto:michael.zingale@stonybrook.edu}{michael.zingale@stonybrook.edu} \\
{\em Class Meeting Time/\/Place:} Mon., Wed., Fri. 8:25~am to 9:20~am, location: Physics S-235 \\
\end{center}
...
Office hours will follow immediately after class on Monday and Friday,
for 1.5 hours.  It is not possible to pick office hours that can
...
\begin{itemize}
\item Mackenzie Baird, \href{mailto:mackenzie.baird@stonybrook.edu}{mackenzie.baird@stonybrook.edu}
\item Alex Heindel, \href{mailto:alex.heindel@stonybrook.edu}{alex.heindel@stonybrook.edu}
\end{itemize}
Office hours for the TAs will be announced in the first week of classes.
...
{\bf Mathlab computer policy}: you are responsible for making frequent
backups of any work you do on the Mathlab computers.  Homeworks are
still due at the scheduled time even if you are locked out of one of
the Mathlab servers due to too many failed login attempts, or if there
...
chapters of the text.  Midterm exams will take place {\bf in-class} on the days
assigned by the registrar---{\bf we will
  not use the common exam period scheduled by the registrar for the
  midterms}.  The midterm dates are:
\begin{itemize}
\item Feb.\ 23
\item Apr.\ 6
\end{itemize}
...
Periodically, there will be interactive, in-class activities where you
will be asked to submit something (e.g., via a google form).  This
participation will be marked as either submitted or not-submitted.  At
the end of the semester, your total participation will be averaged,
dropping the lowest 2 scores from throughout the semester (this
accounts for occasional absences).

{\bf No make-ups for in-class participation will be permitted.}
...
\section{Required Syllabus Statement}

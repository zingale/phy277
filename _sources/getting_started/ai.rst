...
We hear a lot today about `artificial intelligence
...
While LLMs can be useful for programming, it is important to first
understand the concepts behind programming, including how to organize
data, create logic, write tests, and more.  This is because LLMs make
mistakes (sometimes confidently) and you may not realize it.  So tools
like LLMs may help with writing some initial code, but shift the
burden onto verifying that the code is correct and writing tests.

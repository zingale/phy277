...
Now let's imagine that our project is mature and we don't want to
break it as we test out some new ideas.  This is where *branches* come
into play.
...
Now notice that if you do ``ls``, you don't see ``hello.cpp``!

That file is in your ``feature`` branch, and under git control, and git
...
.. tip::
   ...
   You don't need to type out the entire hash---you only need the
   starting bits, as long as it is unique.

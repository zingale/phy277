...
This is what `version control <https://en.wikipedia.org/wiki/Version_control>`_ does for us.
...
.. tip::
   ...
   https://github.com/zingale/phy277
...
Examples: `CVS <https://en.wikipedia.org/wiki/Concurrent_Versions_System>`_, `subversion <https://en.wikipedia.org/wiki/Apache_Subversion>`_
...
Examples: `git <https://en.wikipedia.org/wiki/Git>`_, `mercurial <https://en.wikipedia.org/wiki/Mercurial>`_
